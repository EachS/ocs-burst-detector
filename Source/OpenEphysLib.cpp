...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "OcsBurstDetector"; // <---- update
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "Ocs Burst Detector"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<OcsBurstDetector>);
		break;
	default:
		return -1;
		break;
